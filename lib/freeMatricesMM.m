function[M,K,Kc,T1,T2,T3]=freeMatricesMM(E,v,rho,eta,t,SF,DSF,mesh,dof)
% Mass and stiffness matrices computation for multi-material problems.
% =========================================================================
...
%              1x3 array. 
%              [E_viscoelastic, E_core]
%   v        = Poisson's ratio [-]
%              1x3 array
%              [v_viscoelastic, v_core]
%   rho      = Density of the material [kg/mm3]
%              1x3 array
%              [rho_viscoelastic, rho_core]
...
nE          = size(mesh.top,2);
nDof_glob   = 2*nn;
nn_in_E     = ( size(mesh.top,1) - 1 );   % Nº of nodes in an element

NPG         = 3;                          % Number of integration points

nDofn       = 2;
nDofEl      = nDofn*nn_in_E;

dof_local   = reshape((1:nDofEl).',nDofn,nn_in_E)';
