...
% 
% The heading of this function must be updated yet.
%
...
%%% Gauss table
[xi_0, eta_0, w] = gaussTable_Tri_Victor(NPG);
...
D = E/((1 + v)*(1 - 2*v)) * [(1-v) v  v  0 ; v (1-v) v     0        ;...
                               v   v 1-v 0 ; 0   0   0 (1-2*v)/2   ];
...
for e=1:nE
    ...
    for it = 1:NPG      % Gauss quadrature
        ...
        me = me +  w(it) * ( N_0.'*N_0) * J * rho * 2 * pi * (eta_0(it));
